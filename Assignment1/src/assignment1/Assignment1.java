...
public class Assignment1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Display your name and Student No. here: Bugra Fatih Demiryurek 200460059 \n\n");
        ...
        try {
            ...
            System.out.println("Test 5b: Trying to set last name as a number: \"1235\" -" + medium + " marks");
